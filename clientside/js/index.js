...
async function getProducts() {
    ...
    if(res.status==200){
        ...
        document.getElementById("log").innerHTML="<a href='./pages/signin.html'><button>LOGIN</button></a>"
        document.getElementById("sell").innerHTML=`<a href="./pages/signin.html"><button>LOGIN</button></a>`
